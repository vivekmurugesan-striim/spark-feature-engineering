...
# To filter transaction features
spark-submit --master local[*] --driver-memory 4g --executor-memory 4g --class "com.test.feature.engg.TransactionRecordFilter"  target/fraud-detection-ml-featureengg-1.0-SNAPSHOT-jar-with-dependencies.jar /home/ec2-user/ml-data/data output >target/out.txt 2>target/err.txt &

# To filter Fraudulent flags
spark-submit --master local[*] --driver-memory 4g --executor-memory 4g --class "com.test.feature.engg.RandomFradulentDataFilter"  target/fraud-detection-ml-featureengg-1.0-SNAPSHOT-jar-with-dependencies.jar /home/ec2-user/ml-data/data output >target/out.txt 2>target/err.txt &

# To generate rule base fraudulent markings
spark-submit --master local[*] --driver-memory 4g --executor-memory 4g --class "com.test.feature.engg.RuleBasedFraudTransMarker"  target/fraud-detection-ml-featureengg-1.0-SNAPSHOT-jar-with-dependencies.jar /home/ec2-user/ml-data/data output >target/out.txt 2>target/err.txt &
