...
public class SparkDriver {
    public static void main(String[] args) {
        ...
        Dataset<Row> merchFeats = FeatureGenerationUtils.generateMerchantFeatures(transactions, merchants, fraudTransactions);
        ...
        Dataset<Row> custMerchCatFeats = FeatureGenerationUtils.generateCustomerMerchantCategoryFeatures(transactions, merchants);
        ...
        custMerchCatFeats.write().mode("overwrite").option("header", "true").csv(outputDir + "/CustomerMerchantCategoryFeatures");
